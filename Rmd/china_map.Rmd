...
maoyang = townships %>% filter(shapeName == "Maoyangxiang")

sites = bind_rows = bind_rows(wanning, tengchong, yingjiang, huangchuan, dengzhou, shangqiu, guantang, maoyang)
