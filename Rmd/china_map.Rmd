...
clim_plot = clim_henan %>%
  ...
  scale_y_continuous(sec.axis = sec_axis(trans = ~.*scale_prec, name="mm")) +
  scale_color_manual(values = c("Precipitation"="darkblue", "Temperature"="tomato")) +
  labs(color = NULL, x = "Month", y = "Celsius") + 
...
```{r}
map_plot + clim_plot + plot_layout(widths = c(2, 1))
ggsave("../plots/henan.png", width=6, height=3, dpi=300)
```